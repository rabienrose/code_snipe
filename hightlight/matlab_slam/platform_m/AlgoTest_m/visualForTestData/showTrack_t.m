function showTrack_t(varargin)
    ...
    lastIdInner = coreDataMatrix.frImgIdVec(frameId + trackBack);
    ...
    % Show
    image1 = imread(coreDataMatrix.frImgDirMatrix{lastIdInner});
    image2 = imread(coreDataMatrix.frImgDirMatrix{currIdInner});
    % just for test
