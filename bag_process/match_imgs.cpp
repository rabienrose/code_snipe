...
//    std::string img2_name = "/Volumes/chamo/dataset/cap_20170323061404/image/110.jpg";
    std::string img1_name = "/home/chamo/Documents/img_572.jpg";
    std::string img2_name = "/home/chamo/Documents/img_605.jpg";
    ...
    cv::Mat inliers;
    findFundamentalMat(points1, points2, cv::FM_RANSAC, 1., 0.9999, inliers);
